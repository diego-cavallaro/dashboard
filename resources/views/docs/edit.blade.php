        ...
        <div class="card-body">
            <form method="POST" action="{{route('docs.update', $doc)}}">
                ...
                <div class="col-sm-3">
                    ...
                    <div class="form-group">
                        <label>Fecha de publicación : {{optional($doc->published_at)->format('d/m/Y')}}</label>
                        <p>
                            <button class="btn btn-block btn-outline-success btn-sm" type="button" data-toggle="collapse" data-target="#collapseDate" aria-expanded="false" aria-controls="collapseExample">
                                Cambiar
                            </button>
                        </p>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label">Borrador</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="public" value = "1">
                            <label class="form-check-label">Version Final</label>
                        </div>
                    </div>
                    <hr>
                    <br>
